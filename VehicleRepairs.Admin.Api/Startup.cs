namespace VehicleRepairs.Admin.Api
{
    using AutoMapper;
    using MediatR;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Version = "v1",
                    Title = "Vehicle Repair Admin API",
                    Description = "Vehicle Repair Admin API",
                    TermsOfService = null,
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                c.RoutePrefix = "";
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Vehicle Repair Admin API V1");
            });
        }
    }
}
